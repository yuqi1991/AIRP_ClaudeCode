...
| Content-neutral Agent Framework direction | Accepted architecture | Framework 只负责 Agent/Graph/Artifact/Trace 运作；当前 RP Turn Adapter 继续负责正则、MVU、回合解析和故事投影，Project 选择 Adapter | ADR-0018 | 首阶段仍需把生产代码迁出 `skills/`，并隔离旧配置兼容路径 |
