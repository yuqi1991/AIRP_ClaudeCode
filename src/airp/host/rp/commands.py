"""Session command API — sole external entry into the AIRP Graph runtime.
...
:class:`~airp.host.rp.session_runtime.SessionTurnRuntime` write paths directly.
...
from airp.host.rp.session_runtime import RuntimeEvent, RuntimeResult, SessionTurnRuntime
